...
/* harmony import */ var _poodle__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./poodle */ "./lib/poodle.js");
...
var Game = /*#__PURE__*/function () {
  ...
  _createClass(Game, [{
    ...
    value: function addDifficulty(difficulty) {
      ...
      ;
      this.addPlatforms();
      this.poodle = new _poodle__WEBPACK_IMPORTED_MODULE_2__["default"](this.dimensions, difficulty);
    }
  }, {
    key: "startTimer",
    ...
    value: function addHighScore() {
      var _this3 = this;
      var input = document.querySelector('#highscore-input');
      var item = {
        player: input.value,
        score: this.score
      };
      ...
      this.scoreBoards.forEach(function (scoreboard) {
        return _this3.populateScoreboard(scoreboard);
      });
    }
  }, {
    key: "submitHighScore",
    ...
    value: function populateScoreboard(scoreboard) {
      ...
      var list = leadersList.map(function (leader, i) {
        var displayScore = _this4.timer.convertElapsedTime(leader.score, true);
        return "\n                    <li class='scoreboard-list-item'>\n                        #".concat(i + 1, " | ").concat(displayScore, " | \n                        ").concat(leader.player, " \n                    </li>\n                ");
      });
      var l = [];
      for (var i = 0; i < 3; i++) {
    ...
    value: function updateScore() {
      ...
      var displayScore = this.timer.convertElapsedTime(this.score);
...
var Timer = /*#__PURE__*/function () {
  ...
  _createClass(Timer, [{
    ...
    key: "convertElapsedTime",
    value: function convertElapsedTime(time) {
      var forScoreBoard = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      ...
      var displayTime = minutes + seconds + "." + this.pad(milliseconds);
      return displayTime;
    }
  }, {
    key: "pad",
